...
public class AttendanceController {
  ...
  @Operation(
      ...
      description =
          "Use this endpoint to delete all attendance, please use with care as there is no"
              + " confirmation. Principal only.")
  ...
  @Operation(
      ...
      description =
          "Use this endpoint to absent all students that has no attendance, please use with care as"
              + " there is no confirmation. Principal only.")
  @PreAuthorize("hasRole('PRINCIPAL')")
