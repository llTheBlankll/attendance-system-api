...
public interface AttendanceService {
  ...
  Iterable<Attendance> getStudentAttendanceBetweenDateStatus(
  ...
  Iterable<Attendance> getAttendanceInSection(
      Integer sectionId, DateRange dateRange, Status status);
