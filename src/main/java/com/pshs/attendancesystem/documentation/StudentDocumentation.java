...
public class StudentDocumentation {
	...
	public static final String SEARCH_STUDENTS_BY_FIRST_LAST_NAME = "Search for students based on both their first and last name.";
	public static final String IS_LRN_EXIST = "Check if a student record exists in the database using their unique identifier.";
	public static final String IS_STUDENT_ATTENDED = "Check if a student has attended a specific date.";
	public static final String DELETE_STUDENT_BY_LRN = "Delete a student record from the database using their unique identifier.";
	public static final String CREATE_STUDENT = "Create a new student record in the database.";
	public static final String UPDATE_STUDENT = "Update an existing student's information in the database.";
