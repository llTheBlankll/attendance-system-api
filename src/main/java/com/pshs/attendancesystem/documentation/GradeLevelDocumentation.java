...
public class GradeLevelDocumentation {

	public static final String GET_ALL_GRADE_LEVELS = "Retrieve a list of all grade levels from the database.";
	public static final String DELETE_GRADELEVEL = "Delete Grade level by Gradelevel Object";
	public static final String CREATE_GRADELEVEL = "Create a new grade level record in the database.";
